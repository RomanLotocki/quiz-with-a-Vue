...
<div class="flex justify-center">
    ...
    <p class="font-light my-2"><b>Quiz with a Vue</b> est une petite application web destinée à tester tes connaissances sur des sujets divers et
      variés et à apprendre des choses par la même occasion.</p>
    <p class="font-light my-2">L'idée est à terme de proposer un grand nombres de questions et des nouveaux features comme des
    ...
    <p class="font-light my-2">Bref... Tu as compris.</p>
    <p class="font-light my-2">Tu vas irrémédiablement découvrir mes centres d'intérêt au fil des questions même si je promets d'être le
      plus exhaustif possible dans le choix des thématiques.</p>
    <p class="font-light my-2">Si ce projet t'intéresse, si tu souhaites y collaborer que ce soit sur le contenu ou sur la forme, n'hésite
