    ...
    <div class="flex justify-center">
        ...
        <div v-else class="max-w-4xl px-10 my-4 py-6 bg-custom-white rounded-lg shadow-md">
            <div class="font-light text-center">
                ...
                <p v-if="storeQuiz.falseAnswerClass">Tu as répondu correctement à <span class="font-bold">{{
                    storeQuiz.currentIndex }}</span> questions</p>
                <p v-if="storeQuiz.falseAnswerClass === false">Tu as répondu à toutes les questions du Quiz. Tu es
                    officiellement génial(e) <span class="text-2xl">&#129504;</span></p>
            </div>
...
const currentItem = computed(() => {
    return storeQuiz.quizData[storeQuiz.currentIndex];
});
